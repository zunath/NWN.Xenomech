...
namespace XM.Migration.PlayerMigration
{
    [ServiceBinding(typeof(IPlayerMigration))]
    internal class _1_BaseMigration: IPlayerMigration
    {
        ...
        public void Migrate(uint player)
        {
            ...
            {
                _event.PublishEvent<XMEvent.OnPlayerMigrationBefore>(player);
                return;
            }
            ...
            _event.PublishEvent<XMEvent.OnPCInitialized>(player);
            _event.PublishEvent<XMEvent.OnPlayerMigrationBefore>(player);
        }
