...
{
    public class NuiCheckConverter : JsonConverter<NuiCheck>
    {
        public override NuiCheck Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return new NuiCheck(label, selected);
        }

        public override void Write(Utf8JsonWriter writer, NuiCheck value, JsonSerializerOptions options)
        {
