...
using NWN.Xenomech.API.Enum.Item.Property;
using NWN.Xenomech.API.Enum.VisualEffect;
using Alignment = NWN.Xenomech.API.Enum.Alignment;
using AttackBonus = NWN.Xenomech.API.Enum.AttackBonus;
using BodyNode = NWN.Xenomech.API.Enum.BodyNode;
using DamageBonus = NWN.Xenomech.API.Enum.Item.Property.DamageBonus;
using DamagePower = NWN.Xenomech.API.Enum.DamagePower;
...
using InvisibilityType = NWN.Xenomech.API.Enum.InvisibilityType;
using MissChanceType = NWN.Xenomech.API.Enum.MissChanceType;
using RacialType = NWN.Xenomech.API.Enum.RacialType;
...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
        ...
        {
            VM.StackPush(eEffect, (int)EngineStructure.Effect);
            VM.Call(849);
        ...
        ///   Activate oItem.
        /// </summary>
        public static IntPtr EventActivateItem(uint oItem, Location lTarget, uint oTarget = OBJECT_INVALID)
        {
            VM.StackPush(oTarget);
        ...
        {
            VM.StackPush(eParentEffect, (int)EngineStructure.Effect);
            VM.StackPush(eChildEffect, (int)EngineStructure.Effect);
            VM.Call(199);
            return VM.StackPopStruct((int)EngineStructure.Effect);
        }
