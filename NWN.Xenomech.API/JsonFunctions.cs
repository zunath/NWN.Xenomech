...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
        ...
        {
            VM.StackPush(jObject, (int)EngineStructure.Json);
            VM.Call(983);
        ...
        {
            VM.StackPush(nIndex);
            VM.StackPush(jArray, (int)EngineStructure.Json);
            VM.Call(987);
        ...
        public static Json JsonPointer(Json jData, string sPointer)
        {
            ...
            VM.StackPush(jData, (int)EngineStructure.Json);
            VM.Call(993);
        ...
        {
            VM.StackPush(jPatch, (int)EngineStructure.Json);
            VM.StackPush(jData, (int)EngineStructure.Json);
            VM.Call(994);
        ...
        {
            VM.StackPush(jRHS, (int)EngineStructure.Json);
            VM.StackPush(jLHS, (int)EngineStructure.Json);
            VM.Call(995);
        ...
        {
            VM.StackPush(jMerge, (int)EngineStructure.Json);
            VM.StackPush(jData, (int)EngineStructure.Json);
            VM.Call(996);
            ...
            JsonFind nConditional = Enum.JsonFind.Equal)
        {
            ...
            VM.StackPush(nNth);
            VM.StackPush(jNeedle, (int)EngineStructure.Json);
            VM.StackPush(jHaystack, (int)EngineStructure.Json);
            VM.Call(1031);
        ...
        {
            VM.StackPush(jOther, (int)EngineStructure.Json);
