...
using CameraTransitionType = NWN.Xenomech.API.Enum.CameraTransitionType;
using ClassType = NWN.Xenomech.API.Enum.ClassType;
using CombatMode = NWN.Xenomech.API.Enum.CombatMode;
using CreatureType = NWN.Xenomech.API.Enum.Creature.CreatureType;
using DamageType = NWN.Xenomech.API.Enum.DamageType;
using EncounterDifficulty = NWN.Xenomech.API.Enum.EncounterDifficulty;
using EngineStructure = NWN.Xenomech.API.Enum.EngineStructure;
using Gender = NWN.Xenomech.API.Enum.Gender;
using ImmunityType = NWN.Xenomech.API.Enum.ImmunityType;
using InventorySlot = NWN.Xenomech.API.Enum.InventorySlot;
using MetaMagic = NWN.Xenomech.API.Enum.MetaMagic;
using MouseCursor = NWN.Xenomech.API.Enum.MouseCursor;
using ObjectVisualTransform = NWN.Xenomech.API.Enum.ObjectVisualTransform;
using PersistentZone = NWN.Xenomech.API.Enum.PersistentZone;
using ProjectilePathType = NWN.Xenomech.API.Enum.ProjectilePathType;
using SavingThrowType = NWN.Xenomech.API.Enum.SavingThrowType;
using ScreenAnchor = NWN.Xenomech.API.Enum.ScreenAnchor;
using Shape = NWN.Xenomech.API.Enum.Shape;
using SpecialAttack = NWN.Xenomech.API.Enum.SpecialAttack;
using Spell = NWN.Xenomech.API.Enum.Spell;
using SpellSchool = NWN.Xenomech.API.Enum.SpellSchool;
using SubSkill = NWN.Xenomech.API.Enum.SubSkill;
using TalentCategory = NWN.Xenomech.API.Enum.TalentCategory;
using TalentType = NWN.Xenomech.API.Enum.TalentType;
using TalkVolume = NWN.Xenomech.API.Enum.TalkVolume;
...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
        ...
        public static void ActionMoveToLocation(Location lDestination, bool bRun = false)
        {
            ...
            VM.StackPush(lDestination, (int)EngineStructure.Location);
            VM.Call(21);
        }
            ...
            ObjectType nObjectFilter = ObjectType.Creature, Vector3 vOrigin = default)
        {
            ...
            VM.StackPush(lTarget, (int)EngineStructure.Location);
            VM.StackPush(fSize);
        ...
        {
            VM.StackPush(evToRun, (int)EngineStructure.Event);
            VM.StackPush(oObject);
            VM.Call(131);
        }
        ...
        {
            VM.StackPush(lValue, (int)EngineStructure.Location);
            VM.StackPush(sVarName);
            VM.StackPush(oObject);
            VM.Call(152);
        }
        ...
        {
            VM.StackPush(lLocation, (int)EngineStructure.Location);
            VM.Call(225);
            return VM.StackPopFloat();
        }
            ...
            ProjectilePathType nProjectilePathType = ProjectilePathType.Default, bool bInstantSpell = false)
        {
            ...
            VM.StackPush((int)nMetaMagic);
            VM.StackPush(lTargetLocation, (int)EngineStructure.Location);
            VM.StackPush((int)nSpell);
            VM.Call(234);
        }
        ...
        /// </summary>
        public static IntPtr EventSpellCastAt(uint oCaster, Spell nSpell, bool bHarmful = true)
        {
        ...
        {
            VM.StackPush(lLocationB, (int)EngineStructure.Location);
            VM.StackPush(lLocationA, (int)EngineStructure.Location);
            VM.Call(298);
            return VM.StackPopFloat();
        }
        ...
        {
            VM.StackPush(eSpellEffect, (int)EngineStructure.Effect);
            VM.Call(305);
            return VM.StackPopInt();
        }
        ...
        {
            VM.StackPush(oCreature);
            VM.StackPush(tTalent, (int)EngineStructure.Talent);
            VM.Call(306);
            return VM.StackPopInt() != 0;
        }
        ...
        {
            VM.StackPush(oTarget);
            VM.StackPush(tChosenTalent, (int)EngineStructure.Talent);
            VM.Call(309);
        }
            ...
            float fMoveAwayRange = 40.0f)
        {
            VM.StackPush(fMoveAwayRange);
            VM.StackPush(bRun ? 1 : 0);
            VM.StackPush(lMoveAwayFrom, (int)EngineStructure.Location);
            VM.Call(360);
        }
        ...
        {
            VM.StackPush(oPlayer);
            VM.StackPush(locLocation, (int)EngineStructure.Location);
            VM.StackPush(sVarName);
            VM.StackPush(sCampaignName);
            VM.Call(592);
        }
        ...
        {
            VM.StackPush(oPlayer);
            VM.StackPush(jValue, (int)EngineStructure.Json);
            VM.StackPush(sVarName);
            VM.StackPush(sCampaignName);
        ...
        public static void ActionUseItemOnObject(uint oItem, IntPtr ip, uint oTarget, int nSubPropertyIndex = 0, bool bDecrementCharges = true)
        {
            ...
            VM.StackPush(oTarget);
            VM.StackPush(ip, (int)EngineStructure.ItemProperty);
            VM.StackPush(oItem);
            VM.Call(910);
        }
