...
using NWN.Xenomech.API.Enum.Area;
using AreaTransition = NWN.Xenomech.API.Enum.AreaTransition;
using EngineStructure = NWN.Xenomech.API.Enum.EngineStructure;
using FogColor = NWN.Xenomech.API.Enum.FogColor;
using FogType = NWN.Xenomech.API.Enum.FogType;
using ObjectType = NWN.Xenomech.API.Enum.ObjectType;
using Skybox = NWN.Xenomech.API.Enum.Skybox;
using WeatherType = NWN.Xenomech.API.Enum.Area.WeatherType;
...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
        ...
        {
            VM.StackPush(at, (int)EngineStructure.Location);
            VM.Call(870);
            return VM.StackPopInt();
        }
        ...
        public static void SetTileMainLightColor(Location lTileLocation, int nMainLight1Color, int nMainLight2Color)
        {
            ...
            VM.StackPush(lTileLocation, (int)EngineStructure.Location);
            VM.Call(514);
        }
        ...
        {
            VM.StackPush(lTile, (int)EngineStructure.Location);
            VM.Call(517);
            return VM.StackPopInt();
        }
