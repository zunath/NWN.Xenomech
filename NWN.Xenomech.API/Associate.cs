...
using NWN.Xenomech.API.Enum.Associate;
...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
        ...
        ///   original faction.
        /// </summary>
        public static void RemoveSummonedAssociate(uint oMaster, uint oAssociate = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oAssociate);
        ...
        /// </summary>
        public static uint GetAssociate(AssociateType nAssociateType, uint oMaster = NWScript.OBJECT_INVALID, int nTh = 1)
        {
            VM.StackPush(nTh);
            VM.StackPush(oMaster);
        ...
        /// </summary>
        public static void AddHenchman(uint oMaster, uint oHenchman = NWScript.OBJECT_INVALID)
        {
        ...
        /// </summary>
        public static void RemoveHenchman(uint oMaster, uint oHenchman = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oHenchman);
            VM.StackPush(oMaster);
            VM.Call(366);
        ...
        /// </summary>
        public static uint GetHenchman(uint oMaster = NWScript.OBJECT_INVALID, int nNth = 1)
        {
            VM.StackPush(nNth);
            VM.StackPush(oMaster);
            VM.Call(354);
        ...
        /// </summary>
        public static void SummonAnimalCompanion(uint oMaster = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oMaster);
            VM.Call(334);
        }
        ...
        ///   Summon a Familiar
        /// </summary>
        public static void SummonFamiliar(uint oMaster = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oMaster);
            VM.Call(335);
        }
        ...
        /// </summary>
        public static int GetLastAssociateCommand(uint oAssociate = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oAssociate);
            VM.Call(321);
            return VM.StackPopInt();
        ...
        /// </summary>
        public static uint GetMaster(uint oAssociate = NWScript.OBJECT_INVALID)
        {
            VM.StackPush(oAssociate);
            VM.Call(319);
            return VM.StackPopObject();
