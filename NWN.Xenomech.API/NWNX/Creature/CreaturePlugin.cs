...
namespace NWN.Xenomech.API.NWNX.Creature
{
    public static class CreaturePlugin
    {
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.AddFeat(creature, feat);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.AddFeatByLevel(creature, feat, level);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.RemoveFeat(creature, feat);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.RemoveFeatByLevel(creature, feat, level);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetKnowsFeat(creature, feat);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFeatByLevel(creature, level, index);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFeatGrantLevel(creature, feat);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFeatByIndex(creature, index);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetMeetsFeatRequirements(creature, feat);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetRawAbilityScore(creature, ability, value);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetRawAbilityScore(creature, ability);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.ModifyRawAbilityScore(creature, ability, modifier);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetPrePolymorphAbilityScore(creature, ability);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetRemainingSpellSlots(creature, @class, level);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetRemainingSpellSlots(creature, @class, level, slots);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetMaxSpellSlots(creature, @class, level);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.AddKnownSpell(creature, @class, level, spellId);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.RemoveKnownSpell(creature, @class, level, spellId);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetMovementRate(creature, rate);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetSkillRankByLevel(creature, skill, level);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetSkillRankByLevel(creature, skill, rank, level);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetClassByPosition(creature, position, classID, bUpdateLevels);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetRacialType(creature, racialtype);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetBaseSavingThrow(creature, which);
        }
        /// <summary>
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetBaseSavingThrow(creature, which, value);
        }
        ...
        public static void LevelUp(uint creature, int @class, int count = 1, int package = 0)
        {
            NWN.Core.NWNX.CreaturePlugin.LevelUp(creature, @class, count, package);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetAttackBonus(creature, isMelee, isTouchAttack, isOffhand, includeBaseAttackBonus);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetHighestLevelOfFeat(creature, feat);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFeatRemainingUses(creature, feat);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFeatTotalUses(creature, feat);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetFeatRemainingUses(creature, feat, uses);
        }
        ...
        public static int GetTotalEffectBonus(uint creature, int bonusType = 0, uint target = 0, int isElemental = 0, int isForceMax = 0, int savetype = -1, int saveSpecificType = -1, int skill = -1, int abilityScore = -1, int isOffhand = 0)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetTotalEffectBonus(creature, bonusType, target, isElemental, isForceMax, savetype, saveSpecificType, skill, abilityScore, isOffhand);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetOriginalName(creature, name, isLastName);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetOriginalName(creature, isLastName);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetAnimalCompanionCreatureType(creature, type);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetFamiliarCreatureType(creature, type);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetDisarmable(creature);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetDisarmable(creature, disarmable);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetDomain(creature, @class, index, domain);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.SetSpecialization(creature, @class, school);
        }
        ...
        public static void SetFaction(uint creature, int nFactionId)
        {
            NWN.Core.NWNX.CreaturePlugin.SetFaction(creature, nFactionId);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFaction(creature);
        }
        ...
        public static int GetFlatFooted(uint creature)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetFlatFooted(creature);
        }
        ...
        /// <param name="class">The class that this modifier will apply to.</param>
        /// <param name="modifier">The modifier to apply.</param>
        /// <param name="persist">Whether the modifier should be persisted to the .bic file if applicable.</param>
        public static void SetCasterLevelModifier(uint creature, int classID, int modifier, int persist = 0)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCasterLevelModifier(creature, classID, modifier, persist);
        }
        ...
        /// </summary>
        /// <param name="creature">The target creature.</param>
        /// <param name="class">The creature's caster class.</param>
        /// <returns>The current caster level modifier for the creature.</returns>
        public static int GetCasterLevelModifier(uint creature, int classID)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCasterLevelModifier(creature, classID);
        }
        ...
        public static void SetCasterLevelOverride(uint creature, int classID, int casterLevel, int persist = 0)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCasterLevelOverride(creature, classID, casterLevel, persist);
        }
        /// <summary>
        ...
        public static int GetCasterLevelOverride(uint creature, int classID)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCasterLevelOverride(creature, classID);
        }
        ...
        public static void SetCriticalMultiplierModifier(uint creature, int modifier, int hand = 0, int persist = 0, int baseItem = -1)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCriticalMultiplierModifier(creature, modifier, hand, persist, baseItem);
        }
        ...
        public static int GetCriticalMultiplierModifier(uint creature, int hand = 0, int baseItem = -1)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCriticalMultiplierModifier(creature, hand, baseItem);
        }
        ...
        public static void SetCriticalMultiplierOverride(uint creature, int overrideValue, int hand = 0, int persist = 0, int baseItem = -1)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCriticalMultiplierOverride(creature, overrideValue, hand, persist, baseItem);
        }
        ...
        public static int GetCriticalMultiplierOverride(uint creature, int hand = 0, int baseItem = -1)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCriticalMultiplierOverride(creature, hand, baseItem);
        }
        ...
        /// <param name="persist">Whether the modifier should persist to .bic file if applicable.</param>
        /// <param name="baseItem">Applies the modifier only when the attack used this baseitem. BASE_ITEM_GLOVES for Unarmed, '-1' for all.</param>
        public static void SetCriticalRangeModifier(uint creature, int modifier, int hand = 0, int persist = 0, int baseItem = -1)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCriticalRangeModifier(creature, modifier, hand, persist, baseItem);
        }
        ...
        public static int GetCriticalRangeModifier(uint creature, int hand = 0, int baseItem = -1)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCriticalRangeModifier(creature, hand, baseItem);
        }
        ...
        /// <param name="persist">Whether the modifier should persist to .bic file if applicable.</param>
        /// <param name="baseItem">Applies the override only when the attack used this baseitem. BASE_ITEM_GLOVES for Unarmed, '-1' for all.</param>
        public static void SetCriticalRangeOverride(uint creature, int overrideValue, int hand = 0, int persist = 0, int baseItem = -1)
        {
            NWN.Core.NWNX.CreaturePlugin.SetCriticalRangeOverride(creature, overrideValue, hand, persist, baseItem);
        }
        ...
        public static int GetCriticalRangeOverride(uint creature, int hand = 0, int baseItem = -1)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetCriticalRangeOverride(creature, hand, baseItem);
        }
        ...
        {
            NWN.Core.NWNX.CreaturePlugin.AddAssociate(creature, associate, associateType);
        }
        ...
        public static int GetIsBartering(uint creature)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetIsBartering(creature);
        }
        ...
        public static void SetParryAllAttacks(uint creature, int parry)
        {
            NWN.Core.NWNX.CreaturePlugin.SetParryAllAttacks(creature, parry);
        }
        ...
        public static int GetNoPermanentDeath(uint creature)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetNoPermanentDeath(creature);
        }
        ...
        public static void SetNoPermanentDeath(uint creature, int noPermanentDeath)
        {
            NWN.Core.NWNX.CreaturePlugin.SetNoPermanentDeath(creature, noPermanentDeath);
        }
        ...
        public static System.Numerics.Vector3 ComputeSafeLocation(uint creature, System.Numerics.Vector3 position, float radius = 20.0f, int walkStraightLineRequired = 1)
        {
            return NWN.Core.NWNX.CreaturePlugin.ComputeSafeLocation(creature, position, radius, walkStraightLineRequired);
        }
        ...
        public static void SetBypassEffectImmunity(uint creature, int immunityType, int chance = 100, int persist = 0)
        {
            NWN.Core.NWNX.CreaturePlugin.SetBypassEffectImmunity(creature, immunityType, chance, persist);
        }
        ...
        {
            return NWN.Core.NWNX.CreaturePlugin.GetBypassEffectImmunity(creature, immunityType);
        }
        ...
        public static void DoItemCastSpell(uint caster, uint target, System.IntPtr location, int spellID, int casterLevel, float projectileTime, ProjectilePathType projectilePathType = ProjectilePathType.Default, int projectileSpellID = -1, uint spellCastItem = OBJECT_INVALID, string impactScript = "")
        {
            NWN.Core.NWNX.CreaturePlugin.DoItemCastSpell(caster, target, location, spellID, casterLevel, projectileTime, (int)projectilePathType, projectileSpellID, spellCastItem, impactScript);
        }
        ...
        public static int RunEquip(uint creature, uint item, int inventorySlot)
        {
            return NWN.Core.NWNX.CreaturePlugin.RunEquip(creature, item, inventorySlot);
        }
        ...
        public static void OverrideRangedProjectileVFX(uint creature, int projectileVFX, bool persist = false)
        {
            NWN.Core.NWNX.CreaturePlugin.OverrideRangedProjectileVFX(creature, projectileVFX, persist ? 1 : 0);
        }
        ...
        public static int AddCastSpellActions(uint creature, uint target, System.Numerics.Vector3 targetLocation, int spellID, int multiClass, MetamagicType metaMagic = MetamagicType.None, int domainLevel = 0, ProjectilePathType projectilePathType = ProjectilePathType.Default, bool instant = false, bool clearActions = false , bool addToFront = false)
        {
            return NWN.Core.NWNX.CreaturePlugin.AddCastSpellActions(creature, target, targetLocation, spellID, multiClass, (int)metaMagic, domainLevel, (int)projectilePathType, instant ? 1 : 0, clearActions ? 1 : 0, addToFront ? 1 : 0);
        }
        ...
        public static int GetIsFlanking(uint creature, uint targetCreature)
        {
            return NWN.Core.NWNX.CreaturePlugin.GetIsFlanking(creature, targetCreature);
        }
        ...
        public static void DecrementRemainingSpellSlots(uint creature, int classID, int spellLevel)
        {
            NWN.Core.NWNX.CreaturePlugin.DecrementRemainingSpellSlots(creature, classID, spellLevel);
        }
        ...
        /// <param name="classID">The class id from classes.2da.</param>
        /// <param name="spellLevel">The spell level.</param>
        public static void IncrementRemainingSpellSlots(uint creature, int classID, int spellLevel)
        {
            NWN.Core.NWNX.CreaturePlugin.IncrementRemainingSpellSlots(creature, classID, spellLevel);
        }
        ...
        public static void SetAbilityIncreaseByLevel(uint creature, int level, int ability)
        {
            NWN.Core.NWNX.CreaturePlugin.SetAbilityIncreaseByLevel(creature, level, ability);
        }
