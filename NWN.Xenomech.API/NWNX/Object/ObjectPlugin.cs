namespace NWN.Xenomech.API.NWNX.Object
{
    public static class ObjectPlugin
    {
        ...
        public static void SetPosition(uint oObject, System.Numerics.Vector3 vPosition, bool bUpdateSubareas = true)
        {
            NWN.Core.NWNX.ObjectPlugin.SetPosition(oObject, vPosition, bUpdateSubareas ? 1 : 0);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetCurrentHitPoints(creature);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetCurrentHitPoints(creature, hp);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetMaxHitPoints(creature, hp);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.Serialize(obj);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.Deserialize(serialized);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetDialogResref(obj);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetDialogResref(obj, dialog);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetAppearance(oPlaceable, nAppearance);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetAppearance(oPlaceable);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetHasVisualEffect(obj, nVFX);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetDamageImmunity(obj, damageType);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.AddToArea(obj, area, pos);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetPlaceableIsStatic(obj);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetPlaceableIsStatic(obj, isStatic);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetAutoRemoveKey(obj);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetAutoRemoveKey(obj, bRemoveKey);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetTriggerGeometry(oTrigger);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetTriggerGeometry(oTrigger, sGeometry);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.Export(oObject, sFileName, sAlias);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetInt(oObject, sVarName);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetInt(oObject, sVarName, nValue, bPersist);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.DeleteInt(oObject, sVarName);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetString(oObject, sVarName);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.DeleteString(oObject, sVarName);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetFloat(oObject, sVarName);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetFloat(oObject, sVarName, fValue, bPersist ? 1 : 0);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.DeleteFloat(oObject, sVarName);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.DeleteVarRegex(oObject, sRegex);
        }
        ...
        public static bool GetPositionIsInTrigger(uint oTrigger, System.Numerics.Vector3 vPosition)
        {
            return NWN.Core.NWNX.ObjectPlugin.GetPositionIsInTrigger(oTrigger, vPosition) == 1;
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetInternalObjectType(oObject);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.AcquireItem(oObject, oItem) == 1;
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.ClearSpellEffectsOnOthers(oObject);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.PeekUUID(oObject);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetDoorHasVisibleModel(oDoor) == 1;
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetIsDestroyable(oObject) == 1;
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.DoSpellImmunity(oDefender, oCaster, nSpellId);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.DoSpellLevelAbsorption(oDefender, oCaster, nSpellId, nSpellLevel, nSpellSchool);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetHasInventory(obj, bHasInventory ? 1 : 0);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetCurrentAnimation(oObject);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetAILevel(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetAILevel(oObject, nLevel);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetMapNote(oObject, nID, nGender);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetMapNote(oObject, sMapNote, nID, nGender);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLastSpellCastFeat(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetLastTriggered(oObject, oLast);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetAoEObjectDurationRemaining(oAoE);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetConversationPrivate(oObject, bPrivate ? 1 : 0);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetAoEObjectRadius(oAoE, fRadius);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetAoEObjectRadius(oAoE);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLastSpellCastSpontaneous(oObject) == 1;
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLastSpellCastDomainLevel(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.ForceAssignUUID(oObject, sUUID);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetInventoryItemCount(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.OverrideSpellProjectileVFX(oCreature, nProjectileType, nProjectilePathType, nSpellID, bPersist ? 1 : 0);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLastSpellInstant() == 1;
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetTrapCreator(oObject, oCreator);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLocalizedName(oObject, nLanguage, nGender);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetLocalizedName(oObject, sName, nLanguage, nGender);
        }
