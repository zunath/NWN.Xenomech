...
using Ability = NWN.Xenomech.API.Enum.Item.Property.Ability;
using Alignment = NWN.Xenomech.API.Enum.Item.Property.Alignment;
using AlignmentGroup = NWN.Xenomech.API.Enum.Item.Property.AlignmentGroup;
...
using ItemAppearanceType = NWN.Xenomech.API.Enum.Item.ItemAppearanceType;
using ItemPropertyType = NWN.Xenomech.API.Enum.Item.ItemPropertyType;
using ItemVisual = NWN.Xenomech.API.Enum.ItemVisual;
...
namespace NWN.Xenomech.API
{
    public partial class NWScript
    {
            ...
            float fDuration = 0.0f)
        {
            ...
            VM.StackPush(oItem);
            VM.StackPush(ipProperty, (int)EngineStructure.ItemProperty);
        ...
        {
            VM.StackPush(nProperty, (int)EngineStructure.ItemProperty);
            VM.Call(854);
        ...
        {
            VM.StackPush(iProp, (int)EngineStructure.ItemProperty);
            VM.Call(769);
        ...
        {
            VM.StackPush(iProperty, (int)EngineStructure.ItemProperty);
            VM.Call(734);
            return VM.StackPopInt();
        }
