...
using NWN.Xenomech.API.Enum.Creature;
using ActionMode = NWN.Xenomech.API.Enum.ActionMode;
using AppearanceType = NWN.Xenomech.API.Enum.AppearanceType;
using ClassType = NWN.Xenomech.API.Enum.ClassType;
using CreaturePart = NWN.Xenomech.API.Enum.Creature.CreaturePart;
using CreatureSize = NWN.Xenomech.API.Enum.Creature.CreatureSize;
...
using FootstepType = NWN.Xenomech.API.Enum.FootstepType;
