...
namespace XM.Shared.API.NWNX.ObjectPlugin
{
    public static class ObjectPlugin
    {
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetHasVisualEffect(obj, (int)nVFX) == 1;
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetDamageImmunity(obj, (int)damageType);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetInt(oObject, sVarName, nValue, bPersist ? 1 : 0);
        }
        ...
        {
            return (ObjectInternalType)NWN.Core.NWNX.ObjectPlugin.GetInternalObjectType(oObject);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.DoSpellImmunity(oDefender, oCaster, (int)nSpellId);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.DoSpellLevelAbsorption(oDefender, oCaster, (int)nSpellId, nSpellLevel, (int)nSpellSchool);
        }
        ...
        {
            return (AILevelType)NWN.Core.NWNX.ObjectPlugin.GetAILevel(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetAILevel(oObject, (int)nLevel);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetMapNote(oObject, (int)nID, (int)nGender);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetMapNote(oObject, sMapNote, (int)nID, (int)nGender);
        }
        ...
        {
            return (FeatType)NWN.Core.NWNX.ObjectPlugin.GetLastSpellCastFeat(oObject);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.OverrideSpellProjectileVFX(oCreature, nProjectileType, (int)nProjectilePathType, (int)nSpellID, bPersist ? 1 : 0);
        }
        ...
        {
            return NWN.Core.NWNX.ObjectPlugin.GetLocalizedName(oObject, (int)nLanguage, (int)nGender);
        }
        ...
        {
            NWN.Core.NWNX.ObjectPlugin.SetLocalizedName(oObject, sName, (int)nLanguage, (int)nGender);
        }
