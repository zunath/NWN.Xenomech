...
using NWN.Xenomech.Core.API.Enum.Item.Property;
using NWN.Xenomech.Core.API.Enum.VisualEffect;
using NWN.Xenomech.Core.Interop;
using Alignment = NWN.Xenomech.Core.API.Enum.Alignment;
using DamageType = NWN.Xenomech.Core.API.Enum.DamageType;
using RacialType = NWN.Xenomech.Core.API.Enum.RacialType;
using SpellSchool = NWN.Xenomech.Core.API.Enum.SpellSchool;
