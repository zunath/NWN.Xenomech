using System;
using XM.AI.BehaviorTree.Behaviours;
using XM.AI.BehaviorTree.Composites;
using XM.AI.BehaviorTree.Decorators;
...
namespace XM.AI.BehaviorTree.FluentBuilder
{
    public static class FluentBuilderExtensions
    {
        public static FluentBuilder<TContext> Subtree<TContext>(
            ...
            IBehavior<TContext> subBehavior)
        {
            return builder.PushLeaf(() => subBehavior);
        }
        ...
        {
            return builder.PushLeaf(() => new ActionBehavior<TContext>(name, action));
        }
