...
{
    [ServiceBinding(typeof(DrakesbaneStatusEffect))]
    public class DrakesbaneStatusEffect : StatusEffectBase
    {
        ...
        protected override void OnHit(uint creature, uint target, int damage)
        {
            ...
            {
                Status.ApplyStatusEffect<DrakesbaneDebuffStatusEffect>(creature, target, 3);
            }
        }
    }
}
