...
{
    [ServiceBinding(typeof(StarStrikeStatusEffect))]
    public class StarStrikeStatusEffect : StatusEffectBase
    {
        ...
        protected override void OnHit(uint creature, uint target, int damage)
        {
            ...
            {
                Status.ApplyStatusEffect<StarStrikeDebuffStatusEffect>(creature, target, 3);
            }
        }
    }
}
